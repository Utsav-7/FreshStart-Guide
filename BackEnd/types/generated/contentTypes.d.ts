...
export interface ApiConnectConnect extends Schema.CollectionType {
  ...
  attributes: {
    City: Attribute.Enumeration<
      ['Surat', 'Ahmedabad', 'Anand', 'Nadiad', 'Vadodara']
    >;
...
export interface ApiMentorMentor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Email: Attribute.Email;
    Position: Attribute.Enumeration<['Faculty', 'Student']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiResourceResource extends Schema.CollectionType {
  ...
  attributes: {
    Department: Attribute.Enumeration<['CSE', 'CE', 'IT']> & Attribute.Required;
